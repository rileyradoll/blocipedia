...
RSpec.describe User, type: :model do
  let(:user) { User.create!(email: 'wikiuser@mail.com', password: 'password', password_confirmation: 'password') }
  let(:wiki) { Wiki.create!(title: 'Public wiki cool', body: 'This very cool wiki.', user: user) }
